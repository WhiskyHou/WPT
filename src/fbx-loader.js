/* eslint-disable */
/**
 * copy from https://github.com/mrdoob/three.js/blob/dev/examples/js/loaders/FBXLoader.js
 * @HACK:2802
 * 	tt 平台下 Android 有 inflate 方法
 */
...
THREE.FBXLoader = (function() {
  ...
  GeometryParser.prototype = {
    ...
    parseMeshGeometry: function(relationships, geoNode, deformers) {
      ...
      const morphTarget = relationships.children.reduce(function(morphTarget, child) {
      ...
      switch (type) {
        ...
        case "l":
          ...
          if (window.systemInfo) {
            const typedArr = new Uint8Array(reader.getArrayBuffer(compressedLength));
            if (window.systemInfo.platform.match(/Android/i)) {
              // 只有 tt & android 才有 inflate 方法
              inflate = tt.inflate(typedArr);
            } else {
              inflate = new pako.inflate(typedArr);
            }
          } else {
            // web
            inflate = new pako.inflate(new Uint8Array(reader.getArrayBuffer(compressedLength))); // eslint-disable-line no-undef
          }
